...
/**
 * This is the model class for table "matriks_perbandingan_berpasangan_alternatif".
 *
 * @property int $id
 ...
 */
class MatriksPerbandinganBerpasanganAlternatif extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'matriks_perbandingan_berpasangan_alternatif';
    }
